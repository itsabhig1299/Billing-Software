...
public class AdminChangePassword extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean status=DbOperations.checkOldPassword(old_pwd,"itsabhigupta222@gmail.com");
        if(status)
        {
            if(new_pwd.equals(cnew_pwd))
            {
                boolean status2=DbOperations.updatePassword(new_pwd,"itsabhigupta222@gmail.com");
                if(status2)
                {
